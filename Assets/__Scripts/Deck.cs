...
public class Deck : MonoBehaviour
{
    ...
    public void ReadDeck(string deckXMLText)
    {
        ...
        //вывод проверочной строки чтобы показать как использовать xml
        ...
        for (int i = 0; i < xDecos.Count; i++)
        {
            ...
            deco = new Decorator();//создать экземпляр
        ...
        for (int i = 0; i < xCardDefs.Count; i++)
        {
            ...
            cardDefs.Add(cDef);/*cDef .face — базовое имя спрайта с картинкой для карты. Например,
FaceCard_ll — это базовое имя спрайта с изображением валета, у спрайта
с изображением трефового валета (Jack of Clubs) имя FaceCard_llC, у спрайта
с изображением червового валета (Jack of Hearts) имя FaceCard_llH, и т. д.*/
        }
    }
